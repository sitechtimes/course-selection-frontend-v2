...
onBeforeRouteLeave((to, from, next) => {
  const newAnswers = JSON.stringify(surveyStore.currentResponse);
  //@ts-ignore
  if (
    ...
    console.log(JSON.stringify(surveyStore.currentResponse));
    console.log(surveyStore.currentAnsweredSurvey.answers);

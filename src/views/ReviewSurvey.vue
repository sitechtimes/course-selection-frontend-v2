  ...
  <section class="flex justify-center items-center flex-col">
    <div class="lg:w-2/3 w-11/12">
      ...
      <div class="flex justify-center my-10 flex-col items-center">
        ...
        >
          Once you submit, you will still be able to make changes to your
          survey. However, please do so before the due date.
        </p>
...
const indexAll: number = surveyStore.currentResponse.findIndex(
  (x) => x.id === "allChosenCourses"
);
const indexNote: number = surveyStore.currentResponse.findIndex(
...
const getChoices = (question: surveyQuestion) => {
  ...
  return classes.filter((x: course) => x.subject === question.questionType);
};

const submit = async () => {
  await surveyStore.checkSurvey();

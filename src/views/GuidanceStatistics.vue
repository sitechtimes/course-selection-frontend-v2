<template>
  ...
  <div 
  class="text-2xl md:text-3xl font-semibold hidden sm:flex" 
  v-if="barChart">
  All Courses
  </div>
  <div 
  class="text-2xl md:text-3xl font-semibold sm:flex" 
  v-if="pieChart">Course Ranking
  </div>
  <!-- <div class="pieChart">
...
onMounted(() => {
  console.log(JSON.stringify(guidanceStore.surveyStats))

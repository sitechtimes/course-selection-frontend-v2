<template>
    ...
    <div class="mt-[3rem] text-2xl md:text-4xl text-black"><label for="career">What careers are you considering upon graduation?</label>
    <input type="text" id="career" class="mt-[2rem] h-[4rem] w-[90%] lg:w-[80%] rounded-xl border-4 border-[#7D7D7D]"/></div>
    <div class="mt-[3rem] text-2xl md:text-4xl text-black"><label for="afterSchool">List after-school activities such as clubs, teams, volunteer, or paid employment.</label>

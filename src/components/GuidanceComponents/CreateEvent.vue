      ...
      <div class="event">
        <div class="top flex-row flex items-center">
          ...
          <button class="mt-5" @click="toggleEvent">
            <svg class="x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
              <path
        ...
        <form id="form" ref="form" @submit.prevent="submit(date, name, time)">
          <div class="item">
            ...
            <input class="space" type="text" v-model="title" placeholder="Title" />
          </div>
          <div class="times">
            <div class="item">
              <label class="formt" for="date">
                ...
                Date</label>
              <input class="space d" type="date" v-model="date" placeholder="Date" />
            </div>
            <div class="item">
              <label class="formt" for="time">
                ...
                Time</label>
              <input class="space d" type="time" v-model="time" placeholder="Time" />
            </div>
          </div>
          ...
          <div class="item">
            ...
            <input class="border-2 border-black rounded-md w-112 h-10 p-2 ml-6" placeholder="Select Student" autoComplete="on" list="suggestions"
              v-model="name" />
          </div>
          <div class="item">
            <label class="formt" for="description"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                <path
            ...
            <input class="space" type="text" v-model="description" placeholder="Memo" />
          </div>

<template>
  <div v-if="show"
    ...
    <div class="event flex flex-col">
      ...
      <!-- details -->
      <h3 class="formt flex flex-row text-[#717494] ml-8 xl:text-2xl font-bold" for="emails">
        <svg class="w-px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          <path
            d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
        </svg>
        Student
      </h3>
      <p class="ml-8">{{ meetingDetails.name }}</p>
  <div class="times flex flex-col lg:flex-row">
          <div>
            <h3 class="formt flex flex-row text-[#717494] ml-8 xl:text-2xl font-bold" for="date">
              ...
              Date</h3>
              <p class="ml-8">{{ meetingDetails.date }}</p>
          </div>
          <div>
            <h3 class="formt flex flex-row text-[#717494] ml-8 xl:text-2xl font-bold" for="time">
              ...
              Time</h3>
              <p class="ml-8">{{ meetingDetails.time }}</p>
          </div>
    </div>

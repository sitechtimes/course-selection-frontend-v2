<template>
  <div v-if="show"
    ...
    <div class="event flex flex-col">
      ...
      <!-- details -->
      <h3 class="formt text-2xl flex flex-row text-[#717494] ml-8 font-bold" for="date">
      ...
      <p class="ml-8 p-2">{{ meetingDetails.date }}</p>
      ...
      <p class="ml-8 p-2">{{ meetingDetails.time }}</p>
      ...
      <p class="ml-8 p-2">{{ meetingDetails.name }}</p>
      <h3 class="formt flex flex-row text-[#717494] ml-8 xl:text-2xl pt-3 font-bold" for="description">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path
      ...
      <p class="ml-8 p-2">{{ meetingDetails.memo }}</p>
      <div>
      </div>
      <!-- buttons -->

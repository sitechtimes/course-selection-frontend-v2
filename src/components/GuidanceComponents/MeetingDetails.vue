<template>
  ...
  >
    <div class="event flex flex-col">
      ...
      <!-- details -->
      <h3
        class="text-[1.2rem] flex flex-row text-[#717494] ml-8 xl:text-2xl font-bold"
        for="emails"
      >
        <svg
          class="w-2"
      ...
      <!-- buttons -->
      <div
        class="item submit pt-5 pb-0 ml-6 xl:text-2xl transition duration-300 hover:opacity-50 cursor-pointer w-fit"
      >
        <button
          type="submit"
          @click="toggleDeleteModal"
          class="font-bold bg-[#f28e8e] px-4 py-2 rounded-xl w-fit h-fit"
          id="save"
          ref="save"
        >
          Delete

<template>
  <body>
    <div v-if="show" class="absolute left-[20%] right-[20%] top-[30%] bg-white flex flex-row m-auto mt-5 w-fit h-fit rounded-[1rem] border border-black">
      <div class="event flex flex-col">
        ...
        <!-- details -->
        <h3 class="text-[1.2rem] flex flex-row text-[#717494] ml-8 xl:text-2xl font-bold" for="emails">
        ...
        <p class="ml-4 p-4">{{ meetingDetails.name }}</p>
        <div class="flex flex-row items-end">
          <div>
            <h3 class="text-[1.2rem] flex flex-row text-[#717494] ml-8 xl:text-2xl font-bold" for="date">
          ...
          <div class="pl-16">
            <h3 class="text-[1.2rem] flex flex-row text-[#717494] ml-8 xl:text-2xl font-bold" for="time">
        ...
        <h3 class="text-[1.2rem] flex flex-row text-[#717494] ml-8 xl:text-2xl font-bold" for="description">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
        ...
        <div class="w-[60%] ml-4 mb-8 flex flex-row items-center">
          ...
          <div class="item submit xl:text-2xl transition duration-300 hover:opacity-50 cursor-pointer w-fit">
            <button type="submit" @click="toggleDeleteModal" class="font-bold text-[1.2rem] bg-[#f28e8e] px-4 py-2 rounded-xl w-fit h-fit" id="save" ref="save">Delete</button>
          </div>
        </div>
      </div>
    </div>
    <GuidanceDeleteModal v-show="showDeleteModal" :meetingDetails="meetingDetails" />
  </body>
</template>
